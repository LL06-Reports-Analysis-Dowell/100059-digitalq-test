        ...
        <Container>
            <RectStack>
                <Dowell className="parent-font">
                    ...
                    <div className=" font-weight-400 text-center">
                    ...
                    {/* pay and paid image  */}
                    <div className="paid d-flex justify-content-center">
                        <div>
                            <img src={taptopaid} alt="" className="me-4" />
                        </div>
                        <div>
                            <img src={paid} alt="" />
                        </div>
